    ...
    switch(letter) {
      ...
      case 'G':
        ...
        switch(int_value) {
          ...
          case 17: case 18: case 19:
              ...
              if (int_value != 17) { FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND); } // XY plane only.
            #endif
        ...
        switch(int_value) {
          ...
          case 3: case 4: case 5:
            ...
            switch(int_value) {
              ...
              case 4:
                #ifdef PEN_SERVO
                  FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND); // Pen commands are M3 and M5 only.
                #else
                  gc_block.modal.spindle = SPINDLE_ENABLE_CCW; break;
                #endif
      ...
      default:
        ...
        switch(letter){
          ...
          case 'Z':
            #ifdef PEN_PLOTTER_XY
              FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND); // Includes Z0 and Z jogs; pen uses M3/M5 later.
            #else
              word_bit = WORD_Z; gc_block.values.xyz[Z_AXIS] = value; axis_words |= (1<<Z_AXIS); break;
            #endif

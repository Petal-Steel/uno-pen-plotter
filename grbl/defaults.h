...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 // Keep squared gantry energized after motion.
  #define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
  #define DEFAULT_JUNCTION_DEVIATION 0.01 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
  #define DEFAULT_INVERT_LIMIT_PINS 1 // NC series chains to GND: open/high triggers.
  #define DEFAULT_SOFT_LIMIT_ENABLE 0 // false
  #define DEFAULT_HARD_LIMIT_ENABLE 0  // false
  #define DEFAULT_INVERT_PROBE_PIN 0 // false
  #define DEFAULT_LASER_MODE 0 // false
  #define DEFAULT_HOMING_ENABLE 1 // Homing required after reset; directions must be bench verified.
  #define DEFAULT_HOMING_DIR_MASK 3 // Home X and Y toward negative ends.
